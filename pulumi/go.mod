...
require (
	...
	github.com/pulumi/pulumi-azure-native-sdk/containerservice/v2 v2.92.2 // indirect
	github.com/pulumi/pulumi-azure-native-sdk/resources/v2 v2.92.2 // indirect
